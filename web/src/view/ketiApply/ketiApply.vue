<template>
  <div>
    ...
    <el-table-column label="申请材料" prop="pics" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateKetiApply(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
