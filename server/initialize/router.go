...
func Routers() *gin.Engine {
	...
	PublicGroup := Router.Group("")
	{
		...
		router.InitSimpleUploaderRouter(PublicGroup)        // 断点续传（插件版）
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitNotificationRouter(PrivateGroup)
		router.InitShejiKetiRouter(PrivateGroup)
		router.InitKetiApplyRouter(PrivateGroup)
		router.InitKetiGroupRouter(PrivateGroup)
		router.InitQuestionRouter(PrivateGroup)
		router.InitAnswerRouter(PrivateGroup)
